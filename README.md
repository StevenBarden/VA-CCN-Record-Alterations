...
Nothing has been filed. No qui tam complaint, no tort claim, no lawsuit.
...
**4. The congressional correspondence.**

| File | Date | From |
|---|---|---|
| `Sen_Moodys_Office_Conclusions_and_emails` | — | Senator Moody's office, cover correspondence |
...
Read the Moody cover first — it states what was asked. The March 30 letter contains the assertion that the portal account was active and not locked as of 27 March 2026, which the exports contradict. The May 5 letter invokes 38 C.F.R. § 5705 as the basis for withholding, and states that it will serve as the only formal communication on the matter.
...
**A procedure billed and not performed.** The companion claim, $8,217.00, carries four alveoloplasty line items at $386.00 each. Corrective alveoloplasty was performed by a different surgeon nearly two years later. Those four line items are present in the first export, absent from the second, and present again in the third.
...
- The complete VA medical record, Blue Button export, two versions taken on different dates.
